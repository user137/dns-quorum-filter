...
людина. **Проміжний тег `v0.6.0` (2026-09-22) — Фаза 5 ще відкрита:** ccTLD-блок (T-115..118) і
...
`v0.5.0` бамп-коміт лишився непротегованим — T-241 (v0.5.0 смоук-тест, той самий день) знайшов і
виправив UTF-8→ANSI «мозаїку» в назвах трьох процесів (Task Manager) і ввімкнув сучасний
`TaskDialogIndirect`-стиль (замість класичного `MessageBoxW`) для всіх нативних діалогів трея —
`v0.6.0` тегується вже з цими фіксами. Поставлено з Фази 3: watchdog-процес зі взаємним heartbeat (`dnsqb-watcher`), опційне
