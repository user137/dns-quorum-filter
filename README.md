...
людина. **Проміжний тег `v0.5.0` (2026-09-22) — Фаза 5 ще відкрита:** ccTLD-блок (T-115..118) і
...
Поставлено з Фази 3: watchdog-процес зі взаємним heartbeat (`dnsqb-watcher`), опційне
