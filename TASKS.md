...
підтверджує. Наступна задача в роботі: **T-77** (UI: список заблокованих країн,
over-blocking-попередження, за зразком T-47's overrides-картки), потім T-78/T-80/T-81.
