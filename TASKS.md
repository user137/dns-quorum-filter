...
**Порядок:** 3.0 → ~~T-101~~ (зроблено 2026-09-01) → ~~3.1~~ (зроблено 2026-09-02) → ~~3.2~~ (зроблено 2026-09-02) → ~~3.3~~ (зроблено 2026-09-02) → ~~3.4~~ (зроблено 2026-09-03) →
...
умова #3. Наратив → TASKS-DONE.md. **Наступний — Батч 3.5 (T-96 / T-97 / T-146)** — шифрована
персистентність; власний plan+advisor.
...
**Наступний — Батч 3.5 (T-96 / T-97 / T-146)** — шифрована персистентність; власний plan-mode +
advisor kickoff.
