...
~~3.8: T-156/T-70~~ → ~~T-167~~ → ~~T-168~~ → ~~T-169~~. Далі — перенесені Ф1-гейти (T-66
метрики, живий Chrome-DoH-прохід, `DEFAULT_PROVIDER_IDS`), без номера батчу/фази, user picks.
...
2026-09-05. Наступне — перенесені Ф1-гейти, без номера батчу/фази.**
...
завершено 2026-09-05** (plan+advisor kickoff+closing, 5 комітів). Наступне — перенесені
Ф1-гейти, user picks.
