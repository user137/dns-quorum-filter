...
**GeoIP-workstream (T-74–T-82) завершений.** Далі в Ф2-плані — cert-автоматизація (T-69→T-67,
кожна з власним plan+advisor циклом) або кастомний DoH-провайдер + presets (T-72/T-73). Наступна
задача — за вибором користувача.
