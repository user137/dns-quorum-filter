...
- [x] T-63 — Юніт-тести порядку застосування overrides (Наскрізні вимоги) — уже покрито тестами T-37: `overrides::tests::decision_allowlist_wins_on_conflict` перевіряє пріоритет allowlist над blocklist при конфлікті на тому самому домені; жодного нового коду не знадобилось, лише закриття прогалини в TASKS.md
