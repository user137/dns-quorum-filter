...
~~3.8: T-156/T-70~~. Далі — **T-167** (ревізія документації) або перенесені Ф1-гейти, без
...
закрита.** Наступне — T-167 (ревізія документації) або перенесені Ф1-гейти, user picks.
