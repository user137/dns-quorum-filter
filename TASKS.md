...
- [ ] T-58 — Тести UI↔бекенд каналу за 4 категоріями: smoke, злам/exploit, misuse, fuzz (`proptest`) (8.1) — канал тепер HTTP (T-149), не Tauri IPC; `dispatch.rs`'s наявні тести покривають частину smoke/exploit-категорій за фактом (CSRF-гейт, розмір тіла), формального проходу за всіма 4 категоріями явно не було; T-60 закриває один конкретний рядок misuse-категорії, не всю категорію — три інші приклади з 8.1's misuse-рядка (allow+block конфлікт, битий/мільйон-записів override-файл, швидке багаторазове перемикання) лишаються непокритими
