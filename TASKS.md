...
**T-237/238/239 послідовність, уточнено з користувачем (`AskUserQuestion`, 2026-09-19):
спершу довести Фазу 5 до кінця (Батчі 5.4-5.7), і лише тоді братись за ці три** — не
перемикатись на них зараз.
