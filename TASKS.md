...
- [ ] T-70 — **Windows-половина звужена — `trust_store::uninstall()` (T-49) уже є примітивом,
  який реальний деінсталятор викличе.** Лишається (Windows): сам пакетований деінсталятор
  (MSI/MSIX, T-156) фактично викликає його при видаленні застосунку. **T-67/T-163 додали
