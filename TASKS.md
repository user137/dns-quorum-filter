...
- [ ] T-52 — Мінімальний Tauri UI: тумблери апстрімів, вибір режиму таймауту, статистика заблокованого (8) — T-147/T-148 зроблено (query_log має продюсера, `quorum::EnabledProviders`/`[providers]` реальний per-provider перемикач)
