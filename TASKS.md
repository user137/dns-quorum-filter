...
- [ ] T-52 — Мінімальний Tauri UI: тумблери апстрімів, вибір режиму таймауту, статистика заблокованого (8) — заблоковано на T-148 (T-147 зроблено — query_log тепер має продюсера)
