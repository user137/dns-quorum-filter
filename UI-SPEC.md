...
| Статистика заблокованого (сьогодні) | `u32` | §8 "статистика заблокованого" | лічильник | обчислюваний з логу |
...
| Фасет: заблоковані / дозволені | `enum{ALL,BLOCKED,ALLOWED}` | §6 | сегментований перемикач | одне з трьох |
...
| Рядок логу — `decision` | `ALLOWED/BLOCKED` | §6 | колонка, кольоровий бейдж | лише читання |
